...
; git clone https://github.com/makersacademy/web-applications-in-python-project-starter-html.git music_web_app_html
...
(html-application-starter-venv); createdb music_web_app_html
(html-application-starter-venv); createdb music_web_app_html_test
